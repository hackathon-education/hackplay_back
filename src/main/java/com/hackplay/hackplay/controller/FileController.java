...
public class FileController {
    ...
    public ApiResponse<Void> renameFile(
            @PathVariable("projectId") Long projectId,
            @Valid @RequestBody FileRenameReqDto fileRenameReqDto) throws IOException {
        fileService.rename(projectId, fileRenameReqDto);
        return ApiResponse.success();
    }
    ...
    public ApiResponse<Void> moveFile(
            @PathVariable("projectId") Long projectId,
            @Valid @RequestBody FileMoveReqDto fileMoveReqDto) throws IOException {
        fileService.move(projectId, fileMoveReqDto);
        return ApiResponse.success();
    }
