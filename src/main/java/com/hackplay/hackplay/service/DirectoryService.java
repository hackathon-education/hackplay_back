...
public interface DirectoryService {
    ...
    // 디렉토리명 수정
    void update(Long projectId, Long dirId, DirectoryUpdateReqDto directoryUpdateReqDto) throws IOException;
    // 디렉토리 삭제 (하위 디렉토리/파일 포함)
    void delete(Long projectId, Long dirId) throws IOException;
}
